...
def ending(a: int, b: int, c: int) -> list[str]:
    ...
    papa_line = {
        (1, 1, 1): "Le sac a pris le soleil, toi.",
        (1, 1, 2): "Le vent est entré dans tes manches.",
        (1, 1, 3): "Le doudou a gardé la latte.",
        (1, 2, 1): "Tes pieds n'ont pas glissé, sur le bois.",
        (1, 2, 2): "Tu pourras descendre, le manteau est prêt.",
        (1, 2, 3): "Le tabouret est resté droit, lui.",
        (1, 3, 1): "La poche a gardé l'oiseau, au chaud.",
        (1, 3, 2): "Deux tissus, et tu ne grelottes plus.",
        (1, 3, 3): "Ils se sont endormis dans la laine.",
        (2, 1, 1): "Tes mains ont tenu, sèches, cette fois.",
        (2, 1, 2): "Le manteau a bu la goutte, toi.",
        (2, 1, 3): "Le doudou n'a pas eu d'eau.",
        (2, 2, 1): "La trace ronde, c'est ta chaussette.",
        (2, 2, 2): "Tu es restée droite, près du bois.",
        (2, 2, 3): "Le doudou a vu le moineau, au sec.",
        (2, 3, 1): "La poche sent le savon, et le vent.",
        (2, 3, 2): "Le bouton du manteau a fait le reste.",
        (2, 3, 3): "Le gilet a fait un toit, pour lui.",
        (3, 1, 1): "L'huile a parlé au bois, sans bruit.",
        (3, 1, 2): "Le pain a vu la rue, avec toi.",
        (3, 1, 3): "Il a deux odeurs, le doudou.",
        (3, 2, 1): "Les carreaux n'ont plus piqué tes pieds.",
        (3, 2, 2): "Le manteau gardera le vent, en bas.",
        (3, 2, 3): "Il a une miette, et la rue.",
        (3, 3, 1): "La poche a fait le voyage, toi.",
        (3, 3, 2): "Le four a prêté sa chaleur.",
        (3, 3, 3): "Il écoute le moineau, sans crier.",
    }[(a, b, c)]
    first = {
        1: "Plus tard, le pain est sur la table, tout chaud.",
        2: "Plus tard, une miette roule vers le bol.",
        3: "Plus tard, le four s'est tu, et le pain fume.",
    }[a]
    return vet(
        [
            f"narrateur|{first}",
