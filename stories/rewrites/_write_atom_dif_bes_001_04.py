...
SCRIPTS = {
    ...
    "CHK_T0000_P0000_C0001": (
        ...
        "cubes",
        [
            "narrateur|Nino referme la bouche, un moment.",
            ...
            "narrateur|Il reste près de sa petite tour.",
        ],
    ),
    "CHK_T0000_P0000_END": (
        "obstacle",
        ...
        [
            ...
            "narrateur|La tour tient, plus haute, sur le tapis.",
        ],
    ),
    "CHK_T0000_P0000_END_F0001": (
        ...
        "",
        [
            "narrateur|Ils restent assis sur le tapis, près de la tour.",
