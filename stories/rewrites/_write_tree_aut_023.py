...
def t3_lines(a: int, b: int, c: int) -> list[str]:
    ...
    almost = {
        ...
        (3, 1, 1): "narrateur|La corde tenait la manche, presque.",
        (3, 1, 2): "narrateur|Un cling couvrait le croissant, presque.",
        (3, 1, 3): "narrateur|L'herbe cachait le col, presque.",
        (3, 2, 1): "narrateur|Le seau pesait trop, une seconde.",
        (3, 2, 2): "narrateur|La corde mentait, une seconde de trop.",
        (3, 2, 3): "narrateur|Le pied nu manquait le bord, presque.",
...
def ending_lines(a: int, b: int, c: int) -> list[str]:
    ...
    lasts = {
        ...
        (1, 1, 2): "Le loquet garde un fil rouge, minuscule.",
        (1, 1, 3): "Un grain reste coincé dans la paille.",
        (1, 2, 1): "L'anse du seau sèche, sous la rampe.",
        (1, 2, 2): "Une fraise roule près du pain tiède.",
        (1, 2, 3): "L'ombre du seau s'endort au seuil.",
        (1, 3, 1): "Du sable reste dans l'oreille du doudou.",
        (1, 3, 2): "Près des clés, un fil gris pend.",
        (1, 3, 3): "Au col, un grain de sable brille.",
        (2, 1, 1): "Une feuille sèche, collée au croissant.",
        (2, 1, 2): "Loin du col, le métal se tait.",
        (2, 1, 3): "Sur le bois, un pas s'éteint.",
        (2, 2, 1): "Sous la rampe, le seau penche, vide.",
        ...
        (3, 1, 1): "Près du cric, le ballon s'endort.",
        (3, 1, 2): "Loin du col, la corde se tait.",
        (3, 1, 3): "L'escalier garde un cric, unique.",
        (3, 2, 1): "Sur la marche, l'ombre du seau dort.",
        (3, 2, 2): "Près des fraises, le pain attend.",
        (3, 2, 3): "Dans la coupelle, les clés se taisent.",
        (3, 3, 1): "Au chaud, le doudou sent l'herbe.",
        (3, 3, 2): "Dans le panier, une fraise rentre.",
        (3, 3, 3): "Au crochet, le croissant de cuivre se tait.",
    }
    qs = {
