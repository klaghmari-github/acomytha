...
OPENING = [
    ...
    "narrateur|La gouttière laisse une perle sur le bois.",
    "narrateur|Derrière la porte, la soupe fume, légère.",
    ...
    "narrateur|La bouche de papa se ferme.",
    "narrateur|Les joues de Nino chauffent.",
    "narrateur|Nino tape du pied, un petit coup.",
    "maman|On n'a pas entendu.",
...
T1 = {
    1: {
        ...
        "passage": [
            ...
            "narrateur|Nino serre le bois, trop fort.",
    ...
    2: {
        ...
        "passage": [
            ...
            "narrateur|Nino baisse les yeux, un instant.",
            "maman|Il cherche, les lèvres rondes.",
            "enfant-m|J'écoute, moi.",
    ...
    3: {
        ...
        "passage": [
            ...
            "narrateur|Le chiffon reste en l'air, arrêté.",
            "papa|Ça va venir.",
            "enfant-m|D'accord.",
...
T2 = {
    (1, 1): {
        ...
        "passage": [
            ...
            "enfant-m|Lequel ?",
            "narrateur|Papa tousse, et se tait.",
    ...
    (2, 1): {
        ...
        "passage": [
            ...
            "narrateur|Papa se tait, dans le bruit.",
    ...
    (2, 3): {
        ...
        "passage": [
            ...
            "papa|Tout en haut, près du.",
            "enfant-m|Près du pot ?",
            "narrateur|Papa se tait, Nino retombe.",
            "maman|Le haut est trop loin, pour lui.",
            "papa|Tu fais quoi, alors ?",
        ],
    },
    (3, 1): {
        ...
        "passage": [
            ...
            "enfant-m|Lequel ?",
            "narrateur|L'écharde garde le tissu, piquant.",
            "maman|Les tiroirs se ressemblent tous.",
            "papa|On fait comment, Nino ?",
        ],
    },
    (3, 2): {
        ...
        "passage": [
            ...
            "enfant-m|Ouvre !",
            "narrateur|Maman se tait, le couvercle claque.",
            "papa|Le bois est trop lourd, seul.",
            "maman|Tu trouves comment ?",
        ],
    },
...
T3 = {
    ...
    (1, 3, 1): [
        ...
        "narrateur|Papa tend la main, vers le pot.",
        "narrateur|La roue brille entre deux pots.",
        "maman|Le bleu est là, en haut.",
    ...
    (1, 3, 2): [
        ...
        "maman|Le bleu est monté avec toi.",
        "papa|Le bois a tenu tes pieds.",
    ],
    (1, 3, 3): [
        "enfant-m|Tes bras, papa.",
        "papa|Viens contre moi.",
    ...
    (2, 3, 1): [
        ...
        "papa|Près du pot bleu.",
        "enfant-m|Celui qui brille.",
        "narrateur|Papa tend la boîte, vers le pot.",
        "narrateur|La roue tombe dans la ronde, un toc.",
        "maman|Le bleu brille, près du pot.",
    ...
    (3, 3, 1): [
        ...
        "papa|Près du pot bleu.",
        "enfant-m|Celui qui brille.",
        "narrateur|Papa tend le chiffon, vers le pot.",
        "narrateur|La roue glisse dans le tissu, bleue.",
        "maman|Le bleu est venu, avec le linge.",
...
ENDINGS = {
    (1, 1, 1): [
        ...
        "enfant-m|Il galope !",
        "papa|Sur les carreaux secs, droit devant.",
    ...
    (1, 1, 2): [
        "narrateur|La roue tourne, enfin, bien ronde.",
        "enfant-m|Les copeaux ont volé, d'abord.",
        "papa|Puis on a vu le nom.",
    ...
    (1, 2, 1): [
        ...
        "maman|Oui, le coin était loin.",
        "papa|Le cheval n'a pas crié.",
        "narrateur|Nino fait galoper le cheval, près du coffre.",
    ...
    (1, 3, 1): [
        ...
        "papa|Tu as entendu bleu, à la fin.",
    ...
    (1, 3, 2): [
        ...
        "enfant-m|Le bleu est monté avec moi.",
        "papa|Je remporte le tabouret, après.",
    ...
    (2, 2, 1): [
        ...
        "maman|Oui, j'ai cherché longtemps.",
    ...
    (2, 3, 1): [
        ...
        "papa|Le bleu est tombé dans la ronde.",
        "maman|Un peu de soupe, après le galop.",
    ...
    (2, 3, 2): [
        ...
        "enfant-m|Le bleu est monté avec la boîte.",
        "papa|Je remporte le tabouret, après.",
        "maman|Essuie tes chaussures, Nino.",
    ...
    (2, 3, 3): [
        ...
        "enfant-m|On l'a prise, là-haut, la ronde aussi.",
        "papa|Tes yeux allaient assez loin.",
        "maman|Le haut gardera son ombre.",
    ...
    (3, 2, 1): [
        ...
        "maman|Oui, le coin était sombre.",
    ...
    (3, 3, 1): [
        ...
        "papa|Le bleu est venu sur le linge.",
        "maman|Un peu de soupe, après le galop.",
    ...
    (3, 3, 2): [
        ...
        "enfant-m|Le bleu est monté avec le tissu.",
        "papa|Je remporte le tabouret, après.",
        "maman|Essuie tes chaussures, Nino.",
    ...
    (3, 3, 3): [
        ...
        "enfant-m|On l'a prise, là-haut, le linge aussi.",
        "papa|Tes yeux allaient assez loin.",
        "maman|Le haut gardera son ombre.",
        "narrateur|Nino pose le cheval près des carreaux.",
