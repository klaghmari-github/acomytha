...
KITCHEN = {
    ...
    (2, 2, 3): "La tasse reflète la fenêtre, ronde.",
    ...
    (3, 2, 3): "Maman souffle sur le dessin, un peu.",
...
CIRCLE = {
    ...
    (2, 1, 2): "Le rond sent le cacao, contre le nez.",
    ...
    (3, 3, 1): "Le rond cadre le gond, minuscule.",
