...
| --- | --- | --- | --- |
| Atomique | 597 | 85 / 85 | 1 chemin, `question_lesson` |
| Ramifiée | 676 | 85 / 85 | 3 niveaux × 3 options = 27 feuilles |

Total **1273** histoires. Validateur déterministe : `python3 stories/outils/validate.py` → **1273 APPROVED_TEXT**, 0 REJECTED, 0 REVISION.
