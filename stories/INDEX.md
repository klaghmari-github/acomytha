...
| --- | --- | --- | --- |
| Atomique | 553 | 85 / 85 | 1 chemin, `question_lesson` |
| Ramifiée | 632 | 85 / 85 | 3 niveaux × 3 options = 27 feuilles |

Total **1185** histoires. Validateur déterministe : `python3 stories/outils/validate.py` → **1185 APPROVED_TEXT**, 0 REJECTED, 0 REVISION.
