...
**Corpus texte :** xlsx `stories/arbres/` (source ; texte + prosodie). JSON et audio sont **générés** dans l’app (`TtsApp`, `#/admin/editeur`, F-NAR-024, `stories/FORMAT_JSON_TTS.md`). Un serveur : parent, enfant, éditeur.  
