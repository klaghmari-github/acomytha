...
### Textes TREE live (79)
- AUT-001 **étalon** (avis1 + avis2 + example1) : *Le bateau d’Amir et la rivière du jardin*. T1 = préparer d’abord un objet, les trois partent ; 9 résolutions. Source `feedback_chatgpt/examples/example1/`.
