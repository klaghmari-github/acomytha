...
class Story(Base):
    ...
    main_character: Mapped[str] = mapped_column(String(80), default="")
    places: Mapped[str] = mapped_column(String(240), default="")
    universe: Mapped[str] = mapped_column(String(16), default="")
